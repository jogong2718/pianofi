...
export default function TranscriptionDetailPage() {
  ...
  if (xmlLoading || audioLoading || pdfLoading) {
    return (
        ...
        <div className="container mx-auto md:px-4 pt-8 flex flex-col h-full">
          ...
          <div className="flex items-center justify-between mb-6 flex-shrink-0">
            <div className="flex items-center space-x-4">
              <div className="animate-pulse h-9 w-32 bg-gray-300 dark:bg-gray-600 rounded"></div>{" "}
              {/* Back button */}
              <h1 className="text-2xl font-bold"></h1>
            </div>

            <div className="flex items-center space-x-2">
              <div className="animate-pulse h-9 w-16 lg:w-32 bg-gray-300 dark:bg-gray-600 rounded"></div>{" "}
              {/* Download XML button */}
              <div className="animate-pulse h-9 w-16 lg:w-32 bg-gray-300 dark:bg-gray-600 rounded"></div>{" "}
              {/* Download MIDI button */}
              <div className="animate-pulse h-9 w-20 lg:w-36 bg-gray-300 dark:bg-gray-600 rounded"></div>{" "}
              {/* Edit Sheet Music button */}
            </div>
          </div>
              ...
              <div className="h-full flex-1 w-full mx-auto bg-gray-50 dark:bg-gray-900 overflow-x-hidden overflow-y-auto min-h-0">
                <div className="w-full min-h-full bg-background flex flex-col">
                  ...
                  <div className="w-full bg-background border-b border-border p-3 flex-shrink-0">
                    <div className="animate-pulse h-16 w-full bg-gray-300 dark:bg-gray-600 rounded"></div>{" "}
                    {/* Audio player */}
                  </div>
                  ...
                  <div className="w-full flex-1 bg-background min-h-0">
                    <div
                      className="w-full relative max-w-6xl mx-auto rounded-lg p-3"
            ...
            <div className="hidden lg:flex items-center space-x-2">
              <Button
                ...
                disabled={
                  !xml ||
                  xmlLoading ||
                  downloading === `transcription-${jobId}.xml`
                }
              ...
              <Button
                ...
                disabled={
                  !midi ||
                  midiLoading ||
                  downloading === `transcription-${jobId}.mid`
                }
                className="hover:cursor-pointer"
              >
                <Download className="h-4 w-4 mr-2" />
